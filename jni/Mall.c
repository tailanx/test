...
//删除用户收货地址, 参数 String cid , aid, token, 方法post
...
//获取用户收货地址, 参数 where, offset, limit, group, order, fields,方法get
...
//保存用户收货地址, 参数cid, cname, handset, province, city, district, address, rid, token ， 方法post
...
//获取用户评论, 参数 where, offset, limit, group, order, fields,方法get
...
//获取配送中心, 参数 where, offset, limit, group, order, fields,方法get
...
//获取配送费用, 参数 where, offset, limit, group, order, fields,方法get
...
//获取免邮列表, 参数 where, offset, limit, group, order, fields,方法get
...
//删除收藏, 参数 String userid , goodsid, token, 方法post
...
//获取收藏列表, 参数 where, offset, limit, group, order, fields,方法get
...
//保存收藏, 参数 String userid , goodsid, token, 方法post
...
//获取订单数据, 参数 user_id, code, date, status, offset1, fields，token,方法get
...
//取消订单, 参数 String id , code, token, 方法post
...
//签收订单, 参数 String id , code, token, 方法post
...
//提交订单, 参数 customer_id , ticket_id,recipient_id,pingou_id, goods_ascore,ship_fee,
//ship_type , ship_entity_name, goods_qty_scr,comments, token, 方法post
...
//获取功效列表, 参数 where, offset, limit, group, order, fields,方法get
...
//获取搜索结果列表, 参数 name, fun, brand, price, order1, offset1, limit1,方法get
...
//登录,参数username, password, ip， 方法post
...
//注册,参数username , password, cps, ip， 方法post
