...
public class GetFavoriteList {
	...
	private void setKeysAndValues(String where, String offset, String limit, String group, String order, String fields){
		keys[0] = "api";
		String api = "product.favoliten.getList";
		values[0] = api;
		keys[1] = "where";
		values[1] = where;
...
//		result.append("http://192.168.1.254:802/?");
	...
	public String getFavoritesListJsonString(String where, String offset, String limit, String group, String order, String fields)throws IOException{
