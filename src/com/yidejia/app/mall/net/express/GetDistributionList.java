...
public class GetDistributionList {
	...
	private String TAG = GetDistributionList.class.getName();
	private Context context;
	
	public GetDistributionList(Context context){
		this.context = context;
	}
	
	private void setKeysAndValues(String where, String offset, String limit, String group, String order, String fields){
		keys[0] = "api";
		String api = "ship.center.getList";
		values[0] = api;
		keys[1] = "where";
		values[1] = where;
...
//		result.append("http://192.168.1.254:802/?");
	...
	public String getListJsonString(String where, String offset, String limit, String group, String order, String fields)throws IOException, TimeOutEx{
