 ...
 *
 */
public class GetOrderNoEva {
	private String[] keys = new String[11];
	private String[] values = new String[11];
	private String TAG = GetOrderNoEva.class.getName();
	private Context context;
	
	public GetOrderNoEva(Context context){
...
//		result.append("http://192.168.1.254:802/?");
	...
	public String getHttpResponse(String user_id) throws IOException, TimeOutEx{
