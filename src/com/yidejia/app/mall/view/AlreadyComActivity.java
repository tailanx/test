...
//		this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
	...
	private void InitViewPager(){
	     ...
	     Fragment weekfragment = AlreadyComFragment.newInstance("近一周");
	     Fragment monthFragment = AlreadyComFragment.newInstance("近一月");
	     Fragment yearFragment=AlreadyComFragment.newInstance("近一年");
