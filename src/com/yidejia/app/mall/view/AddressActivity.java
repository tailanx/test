...
//	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mAddresses = addressDataManage.getAddressesArray(myApplication.getUserId(), fromIndex, acount);
...
//					AddressDataManage addressDataManage1= new AddressDataManage(AddressActivity.this);
//					adapter.mAddresses = addressDataManage1.getAddressesArray(myApplication.getUserId(), fromIndex, acount);
					Utility.setListViewHeightBasedOnChildren(listView);
//					listView.setAdapter(adapter);
