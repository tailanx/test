...
public class AllOrderActivity extends SherlockFragmentActivity  {
	    ...
	    public void doClick(View v){
			...
			switch (v.getId()) {
//			case R.id.all_order_item_main_cancal://返回
//				intent.setClass(AllOrderActivity.this,MyMallActivity.class);
//				break;
			case R.id.all_order_item_main_pay://付款
				intent.setClass(this,PayActivity.class);
				startActivity(intent);
				break;
			case R.id.all_order_item_main_cancal://取消
//				this.finish();
			}
			//结束当前Activity；
			finish();
...
//			 
		     ...
		     Fragment weekfragment = AllOrderFragment.newInstance("近一周");
		     Fragment monthFragment = AllOrderFragment.newInstance("近一月");
		     Fragment yearFragment = AllOrderFragment.newInstance("近一年");
