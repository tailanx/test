...
public class HistoryActivity extends SherlockFragmentActivity {
	...
	protected void onCreate(Bundle arg0) {
		...
		super.onCreate(arg0);
		dialog = new Builder(HistoryActivity.this).setMessage(getResources().getString(R.string.sure_delete_history)).setTitle(getResources().getString(R.string.delete_history)).setPositiveButton(getResources().getString(R.string.sure), new android.content.DialogInterface.OnClickListener() {
...
//		}
	...
	OnItemClickListener listener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
			...
			Intent intent = new Intent(HistoryActivity.this,GoodsInfoActivity.class);
	...
	private void setActionBarConfig(){
		...
		right.setText(getResources().getString(R.string.all_delete));
