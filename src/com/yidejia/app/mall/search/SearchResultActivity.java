...
public class SearchResultActivity extends SlidingFragmentActivity {
	...
	private void setFragment(int index, boolean isShowWithList) {
		...
		newFragment = SelledResultFragment.newInstance(newBundle,
				isShowWithList);
		...
		public void onClick(View v) {
			...
			case 1: // 考虑settag
				if (clickIndex != lastIndex) {
					isDesc = true;
					// setTabBackground(lastIndex);
					// priceTextView.setCompoundDrawablesWithIntrinsicBounds(0,
					// 0, R.drawable.price_sort_down, 0);
				} else {
					// priceClickCount++;
					isDesc = !isDesc;
				}
	...
	private void setTabBackground(int lastIndex) {
		...
		case 1:
			...
			priceTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0,
					R.drawable.price_normal, 0);
